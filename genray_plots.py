...
nc_path = Path.cwd() / "00_Genray_Regression_Tests" / "ci-tests"/ "test-CMod-LH-edge-id16"
savefig_path = nc_path / 'output'
#------------------------------------------
#eqdsk_name='eqdsk'
...
eqdsk_name=nc_path / 'g1060728011.01100'  # /test7/ (LHCD)  (genray.in)
...
filenm=nc_path / 'gold-genray.nc' # This is a common name of the file generated by GENRAY 
...
#plt.axis('off')
plt.savefig(savefig_path / 'genray_rays_in_R-phi.png') 
show()
...
plt.savefig(savefig_path / 'genray_wwc_inRZ.png') 
show()
...
plt.savefig(savefig_path / 'genray_rays_inRZ.png') 
show()
#stop
...
if i_ox==2:  # only for O-X transmission case
    ...
    plt.savefig(savefig_path / 'genray_rays_OX_transmission.png') 
    show()
#stop
...
plt.xlabel('$poloidal$ $distance$ $along$ $ray$  $(cm)$')
plt.savefig(savefig_path / 'genray_rays_Ewave_p.png') 
show()
...
plt.savefig(savefig_path / 'genray_rays_Ewave_plus-min_p.png') 
show()    
...
plt.xlabel('$poloidal$ $distance$ $along$ $ray$  $(cm)$')
plt.savefig(savefig_path / 'genray_rays_Vgroup_p.png') 
show()
...
plt.savefig(savefig_path / 'genray_rays_wc_wp_p.png') 
show()
...
plt.savefig(savefig_path / 'genray_rays_refr-index_R.png') 
show()
...
plt.savefig(savefig_path / 'genray_rays_refr-index_p.png') 
show()
...
plt.xlabel('$pol.distance$ $along$ $ray$  $(cm)$')
plt.savefig(savefig_path / 'genray_rays_delpwr_lin.png') 
#plt.savefig(savefig_path / 'genray_rays_delpwr_lin.eps') 
show()
...
plt.xlabel('$pol.distance$ $along$ $ray$  $(cm)$')
plt.savefig(savefig_path / 'genray_rays_delpwr_log.png') 
#plt.savefig(savefig_path / 'genray_rays_delpwr_log.eps') 
show()
...
plt.savefig(savefig_path / 'genray_rays_delpwr_vs_rho.png') 
show()
